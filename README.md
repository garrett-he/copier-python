...
[![ci](https://github.com/garrett-he/copier-python/actions/workflows/ci.yml/badge.svg)](https://github.com/garrett-he/copier-python/actions/workflows/ci.yml)
...
1. Install the latest Copier via command:
    ...
    ```text
    pip install --upgrade copier copier-template-extensions
    ```

2. Use command `copier` to generate a new project:

    ```text
    copier copy gh:garrett-he/copier-python /path/to/destination
    ```
